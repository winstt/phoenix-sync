    ...
    >
      ...
      >
        ...
        <p style={{ color: 'rgba(245,240,235,0.7)', fontSize: '0.95rem', lineHeight: 1.7, margin: 0 }}>
          We are seeking an experienced partner to lead a participatory strategy development process across nine regions in England. Register for the supplier webinar and download the full invitation to tender.
        </p>
        <Link
        ...
        >
          View the tender <ArrowRight size={14} aria-hidden="true" />
        </Link>
      </article>
