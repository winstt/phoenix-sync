    ...
    >
      {hero.imageUrl ? (
        ...
        >
          ...
          <div className="home-hero-fade-side" style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to right, #0d0d0d 0%, rgba(13,13,13,0.85) 15%, rgba(13,13,13,0.35) 30%, transparent 50%)' }} />
