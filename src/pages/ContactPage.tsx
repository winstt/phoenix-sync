...
const faqs: { q: string; a: React.ReactNode }[] = [
  ...
  },
  {
    ...
    a: "Community-led decision making isn't an aspiration for us, it's a founding commitment. Our board of trustees is made up of people with deep roots in and alongside Black and Global Majority and racially minoritised communities, bringing lived experience into the heart of our governance.\n\nWe're also honest that we're still building. As we grow, we are actively developing the structures and processes that ensure communities don't just inform our decisions - they direct them. We'll be sharing more about how that takes shape as we move forward.",
  },
]
