  ...
  return (
    <>
      <PageHero
        ...
        description="We are linking communities and leaders across the UK to amplify collective strength in our communities - championing the leadership and innovation already thriving within Global Majority and racially minoritised communities nationwide."
