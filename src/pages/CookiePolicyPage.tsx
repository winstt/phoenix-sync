...
const tag = (label: string, always?: boolean) => (
  <span style={{ display: 'inline-block', fontSize: '11px', fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', padding: '3px 10px', borderRadius: '100px', marginBottom: '0.5rem', background: always ? 'rgba(232,87,10,0.15)' : 'rgba(255,255,255,0.06)', border: always ? '1px solid rgba(232,87,10,0.3)' : '1px solid rgba(255,255,255,0.1)', color: always ? '#E8570A' : 'rgba(245,240,235,0.5)' }}>{label}</span>
)
